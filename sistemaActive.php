<?php
    ...
    // }
    $sql = "SELECT * FROM `prova`.`todo` WHERE `Status` = 'active' ORDER BY id DESC";
...
<body>
    ...
    <ul class="nav justify-content-center">
        <li class="nav-item">
            <a class="nav-link" href="sistemaHome.php">Home</a>
        </li>
        <li class="nav-item">
            <a class="nav-link2" href="sistemaActive.php">Active</a>
        </li>
        <li class="nav-item">
